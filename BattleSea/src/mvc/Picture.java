...
public enum Picture {
    ...
    EMPTY, //для пустой клетки
    NUM1, NUM2, NUM3, NUM4, NUM5, NUM6, NUM7, NUM8, NUM9, NUM10, //для нумерации строк игрового поля
    ...
    public static final int ROWS = 11; //кол-во строк
    public static final int IMAGE_SIZE = 40; //размер стороны картинки в пикселах
